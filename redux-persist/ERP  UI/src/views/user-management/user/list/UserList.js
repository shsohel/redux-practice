...
const UserList = () => {
    ...
    return (
        <div>
            ...
            <Card>
                <div >
                    ...
                    <DataTable
                        ...
                        onSort={handleSort}
                        // contextMessage={}
                        contextActions={<Button.Ripple onClick={() => { handleDeleteUserRange(); }} className='btn-icon ' color='flat-danger'>
                            <XSquare size={24} />
                        </Button.Ripple>}
                        dense
                        subHeader={false}
            ...
            {
                selectedUser !== null && openUserSidebar ? < UserEditForm data={selectedUser} open={openUserSidebar} toggleSidebar={toggleSidebar} /> : openUserSidebar ? <UserAddForm open={openUserSidebar} toggleSidebar={toggleSidebar} /> : null
            }
        </div>
    );
};
