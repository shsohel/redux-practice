...
const RoleList = () => {
    ...
    return (
        <div>
            ...
            <Card>
                <div >
                    ...
                    <DataTable
                        ...
                        onSort={handleSort}
                        // contextMessage={}
                        contextActions={<Button.Ripple onClick={() => { handleDeleteRoleRange(); }} className='btn-icon ' color='flat-danger'>
                            <XSquare size={24} />
                        </Button.Ripple>}
                        subHeader={false}
                        highlightOnHover
            ...
            {
                selectedRole !== null && openRoleSidebar ? < RoleEditForm data={selectedRole} open={openRoleSidebar} toggleSidebar={toggleSidebar} /> : openRoleSidebar ? <RoleAddForm open={openRoleSidebar} toggleSidebar={toggleSidebar} /> : null
            }
