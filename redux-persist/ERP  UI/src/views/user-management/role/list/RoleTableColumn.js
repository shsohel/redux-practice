        ...
        cell: row => (
            <UncontrolledDropdown>
                ...
                <DropdownMenu right>
                    ...
                    <DropdownItem
                        className='w-100'
                        onClick={() => { store.dispatch( getRoleById( row.id ) ); store.dispatch( handleOpenRoleSidebar( true ) ); }}
                    >
                    ...
                    <DropdownItem
                        tag={Link}
                        to={`/assign-permissions/${row.id}`}
                        className='w-100'
                    >
                        <Lock size={14} color='green' className='mr-50' />
                        <span color='primary' className='align-middle'>Permissions</span>

                    </DropdownItem>

                    <DropdownItem
                        className='w-100'
                        onClick={() => store.dispatch( deleteRole( row.id ) )}
                    >
