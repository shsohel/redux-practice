...
const ModuleList = () => {
    ...
    // ** Global States
    const { modules, total, selectedModule, openModuleSidebar, queryData } = useSelector( ( { modules } ) => modules );
    // ** Size States
    ...
    return (
        <div>
            ...
            <Card>
                <div >
                    ...
                    <DataTable
                        ...
                        onSort={handleSort}
                        // contextMessage={}
                        contextActions={<Button.Ripple onClick={() => { handleDeleteModuleRange(); }} className='btn-icon ' color='flat-danger'>
                            <XSquare size={24} />
                        </Button.Ripple>}
                        subHeader={false}
                        highlightOnHover
            ...
            {
                selectedModule !== null && openModuleSidebar ? < ModuleEditForm data={selectedModule} open={openModuleSidebar} toggleSidebar={toggleSidebar} /> : openModuleSidebar ? <ModuleAddForm open={openModuleSidebar} toggleSidebar={toggleSidebar} /> : null
            }
