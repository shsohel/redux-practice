...
import { deleteBuyerProductDeveloper, getBuyerProductDeveloperById, handleOpenBuyerProductDeveloperSidebar } from '../store/actions';
...
export const BuyerProductDeveloperTableColumns = [
        ...
        cell: row => (
            <UncontrolledDropdown>
                ...
                <DropdownMenu right>
                    ...
                    <DropdownItem
                        className='w-100'
                        onClick={() => { store.dispatch( getBuyerProductDeveloperById( row.id ) ); store.dispatch( handleOpenBuyerProductDeveloperSidebar( true ) ); }}
                    >
