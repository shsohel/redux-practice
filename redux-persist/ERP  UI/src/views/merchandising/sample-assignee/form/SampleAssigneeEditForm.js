...
import { selectedSampleAssigneeNull, updateSampleAgent } from '../store/actions';


const SampleAssigneeEditForm = ( { open, toggleSidebar, data } ) => {
    ...
    const handleCancel = () => {
        toggleSidebar();
        dispatch( selectedSampleAssigneeNull() );
    };
