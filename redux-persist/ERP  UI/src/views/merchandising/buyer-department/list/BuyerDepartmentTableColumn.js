...
import { deleteBuyerDepartment, getBuyerDepartmentById, handleOpenBuyerDepartmentSidebar } from '../store/actions';
...
export const BuyerDepartmentTableColumns = [
    {
        name: 'Buyer Department Name',
        minWidth: '200px',
        selector: 'name',
        sortable: true,
        cell: row => row.name
        ...
        cell: row => (
            <UncontrolledDropdown>
                ...
                <DropdownMenu right>
                    ...
                    <DropdownItem
                        className='w-100'
                        onClick={() => { store.dispatch( getBuyerDepartmentById( row.id ) ); store.dispatch( handleOpenBuyerDepartmentSidebar( true ) ); }}
                    >
