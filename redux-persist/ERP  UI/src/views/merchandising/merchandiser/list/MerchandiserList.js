...
import { deleteRangeMerchandiser, getMerchandiserByQuery, handleOpenMerchandiserSidebar } from '../store/actions';
import MerchandiserExpandRow from './MerchandiserExpandRow';
import { MerchandiserTableColumns } from './MerchandiserTableColumn';
...
// ** Merchandiser Country filter options: Demo Array
...
// ** Merchandiser Status filter options: Demo Array
const statusOptions = [
...
const MerchandiserList = () => {
    ...
    // ** Global States
    const { merchandisers, total, selectedMerchandiser, openMerchandiserSidebar, queryData } = useSelector( ( { merchandisers } ) => merchandisers );
    ...
    // ** Global Function to toggle sidebar for Merchandiser
    ...
    const dataToRender = () => {
        ...
        if ( queryData.length > 0 ) {
            ...
            return merchandisers.slice( 0, rowsPerPage );
        }
    };
    ...
    return <div>
        ...
        <Card>
            <div >
                <CardHeader>
                    <CardTitle tag='h2'>Merchandiser</CardTitle>
                </CardHeader>
                <CustomHeader
                ...
                <DataTable
                    ...
                    expandOnRowClicked
                    columns={MerchandiserTableColumns}
        ...
        {
            selectedMerchandiser !== null && openMerchandiserSidebar ? < MerchandiserEditForm data={selectedMerchandiser} open={openMerchandiserSidebar} toggleSidebar={toggleSidebar} /> : openMerchandiserSidebar ? <MerchandiserAddForm open={openMerchandiserSidebar} toggleSidebar={toggleSidebar} /> : null
        }
