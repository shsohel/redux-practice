...
import { deleteStyleCategory, getStyleCategoryById, handleOpenStyleCategorySidebar } from '../store/actions';
...
export const StyleCategoryTableColumns = [
    {
        ...
        cell: row => (
            <UncontrolledDropdown>
                ...
                <DropdownMenu right>
                    ...
                    <DropdownItem
                        className='w-100'
                        onClick={() => { store.dispatch( getStyleCategoryById( row.id ) ); store.dispatch( handleOpenStyleCategorySidebar( true ) ); }}
                    >
