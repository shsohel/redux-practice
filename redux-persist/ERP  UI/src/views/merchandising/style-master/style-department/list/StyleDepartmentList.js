...
import { deleteRangeDepartment, getDepartmentByQuery, handleOpenDepartmentSidebar } from '../store/actions';
import StyleDepartmentExpandRow from './StyleDepartmentExpandRow';
import { DepartmentTableColumns } from './StyleDepartmentTableColumn';
...
const StyleDepartmentList = () => {
    ...
    // ** Global States
    const { departments, total, selectedDepartment, dropDownDepartments, openDepartmentSidebar, queryData } = useSelector( ( { departments } ) => departments );
    ...
    const dataToRender = () => {
        ...
        if ( queryData.length > 0 ) {
            ...
            return departments.slice( 0, rowsPerPage );
        }
    };
    ...
    return (
        <div>
            ...
            <Card>
                <div >
                    <CardHeader>
                        <CardTitle tag='h2'>Style Department</CardTitle>
                    </CardHeader>
                    <CustomHeader
                    ...
                    <DataTable
                        ...
                        onSort={handleSort}
                        // contextMessage={}
                        contextActions={<Button.Ripple onClick={() => { handleDeleteDepartmentRange(); }} className='btn-icon ' color='flat-danger'>
                            <XSquare size={24} />
                        </Button.Ripple>}
                        dense
                        subHeader={false}
            ...
            {
                selectedDepartment !== null && openDepartmentSidebar ? < StyleDepartmentEditForm data={selectedDepartment} open={openDepartmentSidebar} toggleSidebar={toggleSidebar} /> : openDepartmentSidebar ? <StyleDepartmentAddForm open={openDepartmentSidebar} toggleSidebar={toggleSidebar} /> : null
            }
