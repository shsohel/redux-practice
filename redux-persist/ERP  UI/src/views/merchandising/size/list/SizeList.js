...
import { deleteRangeSize, getSizeByQuery, handleOpenSizeSidebar } from '../store/actions';
import SizeExpandRow from './SizeExpandRow';
import { SizeTableColumns } from './SizeTableColumn';
...
const SizeList = () => {
    ...
    // ** Global States
    const { sizes, total, selectedSize, openSizeSidebar, queryData } = useSelector( ( { sizes } ) => sizes );
    // ** Size States
    ...
    const dataToRender = () => {
        ...
        if ( queryData.length > 0 ) {
            ...
            return sizes.slice( 0, rowsPerPage );
        }
    };
    ...
    return (
        <div>
            ...
            <Card>
                <div >
                    <CardHeader>
                        <CardTitle tag='h2'>Style Size</CardTitle>
                    </CardHeader>
                    <CustomHeader
            ...
            {
                selectedSize !== null && openSizeSidebar ? < SizeEditForm data={selectedSize} open={openSizeSidebar} toggleSidebar={toggleSidebar} /> : openSizeSidebar ? <SizeAddForm open={openSizeSidebar} toggleSidebar={toggleSidebar} /> : null
            }
