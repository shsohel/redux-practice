...
import { deleteSeason, getSeasonById, handleOpenSeasonSidebar } from '../store/actions';
        ...
        cell: row => (
            <UncontrolledDropdown>
                ...
                <DropdownMenu right>
                    ...
                    <DropdownItem
                        className='w-100'
                        onClick={() => { store.dispatch( getSeasonById( row.id ) ); store.dispatch( handleOpenSeasonSidebar( true ) ); }}
                    >
