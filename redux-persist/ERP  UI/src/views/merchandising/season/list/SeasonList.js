...
import { deleteRangeSeason, getSeasonByQuery, handleOpenSeasonSidebar } from '../store/actions';
import SeasonExpandRow from './SeasonExpandRow';
import { SeasonTableColumns } from './SeasonTableColumn';
...
const SeasonList = () => {
    ...
    // ** Global States
    const { seasons, total, selectedSeason, openSeasonSidebar, queryData } = useSelector( ( { seasons } ) => seasons );
    // ** Season States
    ...
    return (
        <div>
            ...
            <Card>
                <div >
                    <CardHeader>
                        <CardTitle tag='h2'>Style Season</CardTitle>
                    </CardHeader>
                    <CustomHeader
            ...
            {
                ( selectedSeason !== null && openSeasonSidebar ) ? < SeasonEditForm
                    data={selectedSeason}
                    open={openSeasonSidebar}
                    toggleSidebar={toggleSidebar}
                /> : ( selectedSeason === null && openSeasonSidebar ) ? <SeasonAddForm
                    open={openSeasonSidebar}
                    toggleSidebar={toggleSidebar}
                /> : null
            }
