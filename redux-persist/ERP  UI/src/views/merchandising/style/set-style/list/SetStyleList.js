...
import { deleteRangeSetStyle, getSetStylesByQuery } from '../store/actions';
        ...
        <div>
            <Row className='mx-0'>
                ...
                <Col className="d-flex align-items-end justify-content-end justify-content-xs-start m-xs-0 ">
                    <Button.Ripple tag={Link} to='/new-set-style' className='btn-icon' color='flat-success'>
                        <PlusSquare size={24} />
                    </Button.Ripple>
                </Col>
            </Row>
...
const SetStyleList = ( { setStyles, total, queryData, toggleForm } ) => {
    ...
    return (
        <div>
            ...
            <Card>
                <div>
                    <CardHeader>
                        <CardTitle tag='h2'>Set Styles</CardTitle>
                    </CardHeader>
                    <CustomHeader
