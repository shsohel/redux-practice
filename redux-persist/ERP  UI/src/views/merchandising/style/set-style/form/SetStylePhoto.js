...
const StylePhoto = ( { photoData, handleUploadPhotoRemove, handleDefaultPhotoOnCarousel } ) => {
    ...
    const hanldeRemovePhotoWithIndex = ( id ) => {
        ...
        return (
            <CarouselItem onExiting={onExiting} onExited={onExited} key={item.id}>
                <div className="image-main-div" >
                    <img src={item.url} alt={item.id} className='image-carousel' />
                    {
                        photoData.length > 0 &&
                        ( <div className="middle">
                            <ButtonGroup className='mb-1 action-btn'>
                                ...
                                <Button.Ripple
                                    onClick={() => { hanldeRemovePhotoWithIndex( item.id ); }}
                                    className='btn-icon'
                                    color='flat-danger'
                                    size="sm"
                                >
